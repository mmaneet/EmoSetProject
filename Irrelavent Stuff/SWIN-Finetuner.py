...
model_checkpoint = "microsoft/swinv2-tiny-patch4-window16-256"  # pre-trained model from which to fine-tune
...
def compute_metrics(eval_pred):
    ...
    acc = accuracy.compute(predictions=predictions, references=eval_pred.label_ids)["accuracy"]
    prec = precision.compute(predictions=predictions, references=eval_pred.label_ids, average="macro")["precision"]
    rec = recall.compute(predictions=predictions, references=eval_pred.label_ids, average="macro")["recall"]
