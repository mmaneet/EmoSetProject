...
model_checkpoint = "swinv2-tiny-patch4-window16-256-emoset-finetune/checkpoint-7380"  # pre-trained model from which to fine-tune
...
json_filename = "SWIN-Eval-Results.json"
